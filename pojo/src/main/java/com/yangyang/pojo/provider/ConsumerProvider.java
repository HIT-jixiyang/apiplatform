...
public class ConsumerProvider {
    public String getConsumerPageListByConsumerExample(Integer pageNo, Integer pageSize, Consumer consumer) throws IllegalAccessException {
    ...
    public String countPageList(Consumer consumer) throws IllegalAccessException {
        StringBuffer sql = new StringBuffer();
        sql.append("select count(1) from consumer\n");
        sql.append("where ");
        List<String[]> condition = SqlUtil.getNotNullField(consumer);
        if(condition.size() != 0){
            sql.append(getWhere(condition));
    ...
    public static void main(String[] args) throws IllegalAccessException {
        ...
        System.out.println(new ConsumerProvider().getConsumerPageListByConsumerExample(1,90,Consumer));
    }
}
